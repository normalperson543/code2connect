    ...
    <div className="flex flex-col gap-2">
      <div className="flex flex-row gap-2 w-full">
        <div className="flex flex-col gap-2 w-3/4">
          ...
          <Text c="dimmed"><em>Your account is managed by: Centennial HS</em></Text>
        </div>
        <div className="w-1/4">
          <Title order={4}>🏛️ Join a class</Title>
          <Text>If your teacher gave you a class code, enter it here.</Text>
          <Paper shadow="sm" p="sm" radius="sm" withBorder>
            <div className="flex flex-col gap-2">
              <TextInput label="Class code" maxLength={6} styles={{input: {fontFamily: "'Roboto Mono', monospace", textAlign: "center"}}}/>
